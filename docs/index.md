---
title: "Learn Bash & Shell Scripting Free: Beginner to Master Course"
description: "Free Bash/shell scripting course from beginner to advanced -- hands-on lessons with runnable code and real capstone projects. Part of a 37-course free library."
---

# Shell Mastery Path

A structured, module-wise Bash/shell scripting training program that takes you
from your first script to production-grade automation tooling — with runnable
...
| Level | Focus | Modules |
|-------|-------|---------|
| [Level 1 · Entry](level-1/index.md) | Shell foundations | 9 topics + 1 project |
| [Level 2 · Intermediate](level-2/index.md) | Idiomatic, testable shell scripts | 9 topics + 1 project |
| [Level 3 · Advanced](level-3/index.md) | Robustness, security, distribution | 9 topics + 1 project |
| [Level 4 · Master](level-4/index.md) | Production automation & systems | 9 topics + 1 capstone |

## How to use this site

- Work through each level in order — later modules assume earlier ones.
- Every topic page has runnable code snippets — copy them into a local `.sh`
  file or a terminal and experiment.
